"""Settings panel for Google Forms Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__google_forms_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=google_forms_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_google_forms"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Google Forms Settings & Accounts", level=2),
